...
AUTHENTICATION_NEXT_STEPS_AUTHORIZED_URLS = []
AUTHENTICATION_ATTACH_SESSION_TO_IP = True
...
def get_session_age(remember_me: bool):
    return (
        AUTHENTICATION_REMEMBER_ME_SESSION_AGE
        if remember_me
        else AUTHENTICATION_SESSION_AGE
    )
